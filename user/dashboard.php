...
">
  ...
  ">
    ...
    <p style="text-align: right; margin-bottom: 20px;">
      <a href="upload_prescription.php" style="
        ...
        font-size: 14px;
      ">Upload New Prescription</a>
    </p>

    <h3 style="color: #444;">Your Prescriptions</h3>
          ...
          <tr>
            ...
            <td style="padding: 10px; border-bottom: 1px solid #eee;">
              <?php if ($quotation && $quotation['status'] === 'pending'): ?>
                <a href="view_quotation.php?prescription_id=<?php echo $p['prescription_id']; ?>" style="
                  color: #0097a7;
                  text-decoration: none;
                  font-weight: 500;
                ">View Quotation</a>
