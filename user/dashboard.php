...
<body
    ...
    <div
        style="background-color: #ffffff; padding: 30px; border-radius: 12px; box-shadow: 0 8px 16px rgba(0,0,0,0.1); width: 100%; max-width: 900px; ">
        <h2 style="text-align: center; color: #333; margin-bottom: 20px;">Welcome, User</h2>

        <p style="text-align: center; margin-bottom: 20px;">
            <a href="profile.php" style="color: #0097a7; text-decoration: none; font-weight: 500;">View Profile</a>
        </p>

        <p style="text-align: right; margin-bottom: 20px;">
            <a href="upload_prescription.php"
                style="background-color: #0097a7; color: #fff; padding: 10px 16px; border-radius: 6px; text-decoration: none; font-size: 14px; ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 10px; border-bottom: 1px solid #eee;">
                        ...
                        <a href="view_quotation.php?prescription_id=<?php echo $p['prescription_id']; ?>"
                            style="color: #0097a7; text-decoration: none; font-weight: 500; ">View Quotation</a>
                        <?php 
                                else: 
                            ?>
                        —
