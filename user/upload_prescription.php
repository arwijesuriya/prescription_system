...
">
  ...
  ">
    ...
    <?php if (isset($message)) echo "<p style='background: #e0ffe0; color: #007700; padding: 10px; margin-bottom: 15px; border-radius: 6px;'>$message</p>"; ?>
    <?php if (isset($error)) echo "<p style='background: #ffe0e0; color: #b20000; padding: 10px; margin-bottom: 15px; border-radius: 6px;'>$error</p>"; ?>

    <form method="POST" enctype="multipart/form-data" style="display: flex; flex-direction: column;">
      <label for="images" style="margin-bottom: 5px; font-weight: 500; color: #555;">Prescription Images (max 5)</label>
      <input type="file" id="images" name="images[]" multiple accept="image/*" required
        style="margin-bottom: 15px; padding: 8px; border: 1px solid #ccc; border-radius: 8px;">

      <label for="note" style="margin-bottom: 5px; font-weight: 500; color: #555;">Note</label>
      ...
      <label for="delivery_address" style="margin-bottom: 5px; font-weight: 500; color: #555;">Delivery Address</label>
      <input type="text" id="delivery_address" name="delivery_address" required placeholder="Enter delivery address"
        style="margin-bottom: 15px; padding: 12px; border: 1px solid #ccc; border-radius: 8px;">

      <label for="delivery_time_slot" style="margin-bottom: 5px; font-weight: 500; color: #555;">Delivery Time Slot</label>
