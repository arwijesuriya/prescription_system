...
">
  ...
  ">
    <form method="POST" style="display: flex; flex-direction: column;">
      <h2 style="margin-bottom: 20px; color: #333; text-align: center;">Pharmacy Login</h2>

      <?php if (isset($error)) echo "<p style='background: #ffe0e0; color: #b20000; padding: 10px; margin-bottom: 15px; border-radius: 6px; text-align: center;'>$error</p>"; ?>

      <label for="email" style="margin-bottom: 5px; font-weight: 500; color: #555;">Email</label>
      <input type="email" id="email" name="email" required placeholder="Enter your email"
        style="padding: 12px; margin-bottom: 20px; border: 1px solid #ccc; border-radius: 8px;">

      <label for="password" style="margin-bottom: 5px; font-weight: 500; color: #555;">Password</label>
